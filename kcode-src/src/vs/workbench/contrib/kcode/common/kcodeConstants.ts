...
export const KCODE_VIEW_CONTAINER_ID = 'workbench.view.kcode';
export const KCODE_CHAT_VIEW_ID = 'kcode.chat.view';

export const KCODE_CONFIG_DEFAULT_MODEL = 'kcode.models.default';
export const KCODE_CONFIG_OPENAI_API_KEY = 'kcode.providers.openai.apiKey';
