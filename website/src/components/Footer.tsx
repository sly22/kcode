    ...
    <footer className="mt-auto border-t border-border/60 bg-surface/50">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid gap-8 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 font-mono text-xs text-muted">
              <li>
                <span className="text-accent-purple">{SITE.protocol}</span>
                프로토콜
              </li>
              <li>
                <code className="text-accent-blue">{INTEGRATION.modelsEndpoint}</code>
              </li>
              <li className="break-all">
                <code className="text-accent-blue">{INTEGRATION.updateFeedUrl}</code>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-border/40 pt-8 text-xs text-muted sm:flex-row">
          ...
          <p>
            데이터 폴더: <code className="text-foreground">{SITE.dataFolder}</code>
          </p>
        </div>
      </div>
    </footer>
